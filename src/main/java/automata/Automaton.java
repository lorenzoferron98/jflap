...
public class Automaton implements Serializable, Cloneable {
    ...
    private final ArrayList<Note> myNotes = new ArrayList<Note>();
    // LISTENER STUFF
    ...
    private final transient HashSet<AutomataTransitionListener> transitionListeners = new HashSet<AutomataTransitionListener>();
    private final transient HashSet<AutomataStateListener> stateListeners = new HashSet<AutomataStateListener>();
    private final transient HashSet<AutomataNoteListener> noteListeners = new HashSet<AutomataNoteListener>();
    /**
...
//				a.addTransition(ts[i].copy(from, to));
     ...
     *
     * @param to the <CODE>State</CODE> to which all returned transitions
     *           should go to
     ...
     *
     * @param trans the transition object to remove from this automaton.
     */
...
//		}
     ...
     *
     * @param finalState a new final state to add to the collection of final states
     */
...
//	}
    ...
    void distributeTransitionEvent(AutomataTransitionEvent event) {
        ...
        while (it.hasNext()) {
            AutomataTransitionListener listener = it
                    .next();
