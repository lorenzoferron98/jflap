 ...
 * @see Automaton
 * @see State
 * @see Automaton#addState
 * @see Automaton#removeState
 * @see AutomataStateListener
 */
...
public class AutomataStateEvent extends EventObject {
     ...
     * @param region the <CODE>State</CODE> that was added or removed
     * @param add    <CODE>true</CODE> if state added
     * @param move   <CODE>true</CODE> if the state was merely moved
     * @param label  <CODE>true</CODE> if the state was only changed in such a
     *               fashion as
     */
