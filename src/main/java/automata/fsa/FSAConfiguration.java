...
public class FSAConfiguration extends Configuration {
     ...
     * @param parent      the configuration that is the immediate ancestor of this
     *                    configuration
     ...
     *
     * @param input the string that will represent the unprocessed input of the
     *              FSA.
     */
