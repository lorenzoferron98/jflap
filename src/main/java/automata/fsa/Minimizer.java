...
public class Minimizer {
     ...
     *
     * @param group     the group being split
     ...
     * @param terminal  the terminal to split group on
     * @param automaton the automaton
    ...
    public boolean isSplittableOnTerminal(State[] group, String terminal,
        ...
        return getGroupsFromGroupOnTerminal(group, terminal, automaton, tree)
                .size() > 1;
    }
     ...
     *
     * @param state     the state.
     * @param group     the set of states that state might have a transition to.
     ...
     * <CODE>group</CODE>.
     *
     * @param tree  the tree model to search.
     * @param root  the root of tree
     * @param group the object to look for in tree.
    ...
    public ArrayList<State[]> splitOnTerminal(State[] group, String terminal,
        ...
        while (it.hasNext()) {
            ...
            if (statesInGroup.size() > 0) {
                State[] groupstates = statesInGroup
                        .toArray(new State[0]);
     ...
     *
     * @param treeNode the node to print.
     */
     ...
     *
     * @param automaton the automaton being minimized.
     ...
     *
     * @param children the list of groups that were obtained by splitting the group
     ...
     * @param minDfa the minimized form of <CODE>dfa</CODE>.
     * @param tree   the distinguishable groups tree for the automaton being
     *               minimized.
     */
     ...
     *
     * @param group  the group of states
     * @param minDfa the minimized dfa
     ...
     *
     * @param state  the state in the minimized dfa.
     * @param minDfa the minimized dfa.
     * @param dfa    the dfa being minimized.
     */
     ...
     *
     * @param tree the tree
     * @param root the root of <CODE>tree</CODE>
     ...
     *
     * @param automaton the automaton being minimized
     * @param tree      the tree of distinguishable groups for automaton
