...
public class NFAToDFA {
     ...
     * @param automaton the automaton that contains <CODE>states</CODE>
     ...
     * @param automaton the nfa whose states are represented by <CODE>state</CODE>.
     ...
     *
     * @param terminal  the terminal (alphabet character)
     * @param states    the set of states that we are checking to see if they have
     ...
     *
     * @param states1 a set of states
     * @param states2 a set of states
...
//				return false;
     ...
     *
     * @param states the states
     * @param dfa    the automaton that contains a state that is mapped to <CODE>states</CODE>
     ...
     *
     * @param state the state from dfa
     * @param nfa   the nfa being converted to a dfa
     ...
     *
     * @param dfa    the dfa. the automaton the state is added to
     * @param states the set of states from the nfa that this created state in the
     *               dfa will represent
     * @param nfa    the nfa
     ...
     *
     * @param automaton the automaton to convert to a dfa.
