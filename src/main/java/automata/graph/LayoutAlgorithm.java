...
public abstract class LayoutAlgorithm {
     ...
     * @param size              The assumed size of the screen
     * @param buffer            The minimum space from the side of the screen that a vertex can be placed at.  There
     *                          can be different values for the width and height.
     * @param scaleOnlyOverflow If true, will only fill the screen with a graph if the points are outside
     *                          the given size.
     */
     ...
     *
     * @param graph     the graph whose states this method shall move.
     * @param notMoving the set of vertices that will not move at all.
     */
