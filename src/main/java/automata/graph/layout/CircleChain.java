...
public class CircleChain extends VertexChain {
     ...
     * on the screen.
     *
     * @param r        the starting radius from the graph's center from which the <code>radius</code> is calculated.
     ...
     * @param midTheta the degree, in radians, that represents the midpoint of the <code>CircleChain</code>
     *                 with respect to the center of the graph.
     * @param span     The degree, in radians, that represents the maximum degree of the circle part over which the
