...
public class VertexChain {
     ...
     *
     * @param first the first <code>VertexChain</code> to search
     * @param next  the second <code>VertexChain</code> to search
     * @param graph the graph used to search for edges
     */
    ...
    public boolean isEdgeToChainMember(Object vertex) {
        return getDegreeInChain(vertex) > 0;
    }
     ...
     *
     * @param destIndex        the index of the vertex in the <code>VertexChain</code> next to which the subchain will be placed.
     * @param matchingIndex    either the <code>start</code> or the <code>end</code> value.  Determines the vertex that is
     ...
     * @param start            the index in the <code>VertexChain</code> representing the start of the subchain.
     * @param end              the index in the <code>VertexChain</code> representing the end of the subchain.
     * @param shuffleDirection if true, the subchain will be placed to the right of the <code>destIndex's</code> vertex.
