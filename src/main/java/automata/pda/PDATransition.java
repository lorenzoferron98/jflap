...
public class PDATransition extends Transition {
     ...
     * @param inputToRead  the string that the machine should satisfy before moving on to
     *                     the next state.
     * @param stringToPop  the string that the machine should pop from the stack.
     * @param stringToPush the string that the machine should push on to the stack.
     */
     ...
     * transition.
     *
     * @param inputToRead the input to read portion of the transition label.
     */
