...
public class TMConfiguration extends Configuration implements Cloneable {
    private final AcceptanceFilter[] myFilters; //constructed outside and passed in in the constructor. //Constructed once and passed to multiple people.
    /**
     * The tapes.
     */
