...
public interface Encoder {
     ...
     */
    File encode(Serializable structure, File file, Map<?, ?> parameters);
     ...
     * written to a file
     */
    boolean canEncode(Serializable structure);
     ...
     */
    String proposeFilename(String filename, Serializable structure);
}
