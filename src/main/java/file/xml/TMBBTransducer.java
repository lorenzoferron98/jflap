 ...
 * {@link TuringMachineBuildingBlocks} objects.
 *
...
public class TMBBTransducer extends AutomatonTransducer {
     ...
     * @param node the DOM node corresponding to the transition, which should
     ...
     * @see AutomatonTransducer#createTransitionElement
     */
     ...
     * {@link AutomatonTransducer#toDOM} to produce the DOM, and also
     * adds a "tapes" tag containing the number of tapes if the number of tapes
     * is not 1.
     *
     * @param structure the structure, which should be a turing machine
     */
