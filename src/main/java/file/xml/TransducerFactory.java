...
public class TransducerFactory {
     ...
     * @throws IllegalArgumentException if the document does not map to a transducer, or if it does
     ...
     * @throws IllegalArgumentException if the structure does not map to a transducer
     */
     ...
     * argument
     * @throws IllegalArgumentException if the passed argument is not class, nor a transducer, or is
     ...
     * transducer class.
     *
     * @param type           the type tag, or <CODE>null</CODE> if <CODE>transducer</CODE>
     *                       is in fact an instance and the transducer type should be
     *                       retrieved from there
     * @param structureClass the class of the structure
     * @param transducer     either a transducer instance, or a transducer class
     */
