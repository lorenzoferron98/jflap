...
public abstract class Grammar implements Serializable, Cloneable {
    ...
    public Object clone() {
        ...
        try {
            ...
            g = getClass().getDeclaredConstructor().newInstance();
        } catch (Throwable e) {
     ...
     *
     * @param production the production
     * @throws IllegalArgumentException if the production is in some way faulty
     */
     ...
     * @throws IllegalArgumentException if the production is unsuitable somehow
     */
