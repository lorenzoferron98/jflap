...
public class LambdaProductionRemover {
     ...
     *
     * @param grammar   the grammar
     * @param lambdaSet the set of variables in grammar that are on the left hand side
    ...
    public boolean areMoreVariablesWithLambdaProductions(Grammar grammar,
        ...
        return getNewVariableWithLambdaProduction(grammar, lambdaSet) != null;
    }
     ...
     *
     * @param grammar   the grammar
     * @param lambdaSet the set of variables that have lambda productions
     ...
     *
     * @param grammar   the grammar
     * @param lambdaSet the set of variables that have lambda transitions (upon
     ...
     * @param lambdaSet  the set of all variables that have lambda productions and
     ...
     * @param variable  the variable
     * @param grammar   the grammar
     * @param lambdaSet the set of all variables that either have lambda productions
    ...
    public boolean areMoreVariablesToAddToLambdaSet(Grammar grammar,
                                                    Set<String> lambdaSet) {
        return getNewVariableThatBelongsInLambdaSet(grammar, lambdaSet) != null;
    }
     ...
     *
     * @param production the production
     * @param comb       the set of variables that should not be replaced by lambda.
     ...
     *
     * @param binary    a binary number whose length is the same as the length of
     *                  <CODE>variables</CODE>
     * @param variables the set of variables that <CODE>binary</CODE> refers to.
