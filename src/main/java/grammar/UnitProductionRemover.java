...
public class UnitProductionRemover {
     ...
     *
     * @param variable the variable whose dependencies are being found
     * @param grammar  the grammar
     ...
     * @param oldProductions the set of productions whose right hand sides are used as the
     ...
     *
     * @param grammar the grammar
     * @param graph   the variable dependency graph of <CODE>grammar</CODE>.
