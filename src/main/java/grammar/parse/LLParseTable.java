...
public class LLParseTable extends AbstractTableModel implements Serializable,
     ...
     *
     * @param grammar the grammar to create the table for
     */
     ...
     * @throws IllegalArgumentException if either variable or lookahead is not a variable or terminal
     ...
     *
     * @param variable the variable to find the row for
     * @return the row where this variable is
     * @throws IllegalArgumentException if the variable is not a variable in the grammar
     */
     ...
     * differences.
     *
     * @param table the other parse table
     ...
     * not match
     * @throws IllegalArgumentException if the other parse table does not have the same variables and
     *                                  lookahead terminals
     */
     ...
     *
     * @param variable  the stack variable
     * @param lookahead the lookahead terminal
     * @param expansion what to expand the stack variable on when the lookahead
     ...
     *
     * @param productions the new set for the entry
     * @param variable    the stack variable
     * @param lookahead   the lookahead terminal
     * @throws IllegalArgumentException if either variable or lookahead is not a variable or terminal
     *                                  (or $) respectively in the grammar
     ...
     *
     * @param column the index for a column
     */
     ...
     * delimited.
     *
     * @param set the set to put in a space delimited string
     */
     ...
     *
     * @param value the new value for an entry
     */
     ...
     *
     * @param editable <CODE>true</CODE> if entries in this table should be
