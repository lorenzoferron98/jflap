...
public class RegularGrammar extends Grammar {
     ...
     * @throws IllegalArgumentException if the production is in some way illegal for the grammar
     */
     ...
     *
     * @throws IllegalArgumentException if this production is somehow illegal for this grammar (i.e.,
