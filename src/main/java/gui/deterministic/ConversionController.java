...
public class ConversionController {
     ...
     */
    private final boolean validLayout = false;
    /**
     * The layout algorithm.
     */
    private final LayoutAlgorithm layout = new GEMLayoutAlgorithm();
    /**
     ...
     *
     * @param nfa  the NFA we're converting to a DFA
     * @param dfa  the DFA being built
     * @param view the view that needs to be repainted
     */
     ...
     * @throws IllegalArgumentException if the state registered conflicts with any existing
     */
...
//        EDebug.print(state.getLabel());
     ...
     *
     * @param start the initial state we're expanding on a terminal
     * @param point the point that the mouse was released on
     * @param end   optionally the state the mouse was released on, or <CODE>null</CODE>
     * @see TransitionExpanderTool
     */
