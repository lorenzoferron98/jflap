...
public abstract class TransitionCreator {
     ...
     *
     * @param automaton the automaton for which there will be created a compatible
     *                  transition creator
     * @param parent    the component that should be the parent of any dialog boxes or
    ...
    public static TransitionCreator creatorForAutomaton(Automaton automaton,
        ...
        if (automaton instanceof automata.mealy.MealyMachine)
