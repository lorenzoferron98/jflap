...
public class TransitionTool extends Tool {
     ...
     */
    private static final Stroke STROKE = new java.awt.BasicStroke(2.4f);
    /**
     ...
     * @param creator the transition creator for the type of automata we are editing
     */
     ...
     *
     * @see TransitionCreator#creatorForAutomaton
     */
    public TransitionTool(AutomatonPane view, AutomatonDrawer drawer) {
        super(view, drawer);
