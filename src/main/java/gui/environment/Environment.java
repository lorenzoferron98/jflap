...
public abstract class Environment extends JPanel {
     ...
     * one.
     *
     * @param object assumed to be some sort of object that this environment holds;
     ...
     *
     * @param component the component to add, which should be unique for this
     *                  environment
     * @param name      the name this component should be labeled with, which is not
     *                  necessarily a unique label
     * @param tags      the tags associated with the component, or just a raw <CODE>Tag</CODE>
     ...
     *
     * @param component the component to check for membership in this environment
     * @see #add
     * @see #remove
     */
     ...
     *
     * @param enabled <CODE>true</CODE> if editor tagged objects should be
     ...
     *
     * @param component the component to make active
     * @see #getActive
     */
     ...
     *
     * @param component the component to check for enabledness
     ...
     *
     * @param component the component to change the enabledness
     * @param enabled   <CODE>true</CODE> if the component should be made enabled,
     ...
     * component.
     *
     * @param component the component to get the tag for
     ...
     *
     * @param satisfier the satisfier all components and their tags must satisfy
     ...
     *
     * @param satisfier the satisfier to check components and their tags against
