...
public class GrammarTableModel extends GrowableTableModel {
     ...
     */
    private static final Icon ARROW = new ArrowIcon(20, 8);
    ...
    public GrammarTableModel(Grammar grammar) {
        ...
        Arrays.stream(ps).forEach(this::addProduction);
    }
    ...
    public Production[] getProductions() {
        return IntStream.range(0, getRowCount() - 1).mapToObj(this::getProduction).filter(Objects::nonNull).toArray(Production[]::new);
    }
