...
class Turtle implements Cloneable, Serializable {
     ...
     *
     * @param colorName the name of the color to find, which should be a field of
     ...
     *
     * @param turtle the turtle whose bounds we want to include
     */
     ...
     *
     * @param clockwise if <CODE>true</CODE> this is a clockwise turn, and if <CODE>false</CODE>
     ...
     *
     * @param degrees the amount counter-clockwise to turn the turtle
     */
     ...
     *
     * @param down if <CODE>true</CODE> this is a down pitch and if <CODE>false</CODE>
     *             this is an up pitch.
     */
     ...
     *
     * @param right if <CODE>true</CODE> this is a right roll and if <CODE>false</CODE>
     *              this is a left roll.
     */
     ...
     *
     * @param degrees the amount left to roll the turtle
     */
     ...
     *
     * @param change the new angle change
     */
     ...
     *
     * @param distance the distance to move forward (negative value is backward)
     */
     ...
     *
     * @param forward will be <CODE>true</CODE> if the user wishes to move
     ...
     * @throws IllegalArgumentException if the color name could not be retrieved
     * @see #colorForString
     */
     ...
     *
     * @param change the value in degrees to change the hue angle
     */
     ...
     *
     * @param increment <CODE>true</CODE> if we want to progress, and <CODE>false</CODE>
     ...
     *
     * @param change the amount to change the hue angle by
     */
     ...
     *
     * @param increment the new line increment
     */
     ...
     *
     * @param broaden should be <CODE>true</CODE> if the user wants to add the
     ...
     *
     * @param increment the amount to add to the line width; if negative, naturally
