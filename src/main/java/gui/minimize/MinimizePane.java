...
public class MinimizePane extends JPanel {
     ...
     * @param environment the environment this minimize pane will be added to
     */
    public MinimizePane(FiniteStateAutomaton dfa, Environment environment) {
        ...
        for (TreeNode treeNode : groups) {
            MinimizeTreeNode group = (MinimizeTreeNode) treeNode;
     ...
     * @param tree the completed minimized tree; results will be unpredictable if
    ...
    public void beginMinimizedAutomaton(FiniteStateAutomaton dfa,
        ...
        builderController.remainingTransitions.stream().map(o -> (Transition) o).forEach(t -> graph.addEdge(t.getFromState(), t.getToState()));
     ...
     * transitions.
     */
    private class ArrowMinimizeTool extends ArrowNontransitionTool {
        /**
