 ...
 * associated with a {@link PumpingLemmaInputPane}and a
...
public class CasePanel extends JPanel {
     ...
     */
    private static final Dimension PREFERRED_SIZE = new Dimension(350, 480);
    /**
     ...
     * @see PumpingLemmaInputPane#setDecomposition(int[])
     */
