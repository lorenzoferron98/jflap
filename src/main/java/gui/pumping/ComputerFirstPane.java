...
public abstract class ComputerFirstPane extends PumpingLemmaInputPane {
     ...
     */
    private static final String OBJECTIVE = "Prevent the computer from finding a valid partition.";
    /**
     * The description that describes the computer's chosen value of <i>m</i>.
     */
    private static final String DESCRIBE_M = "I have selected a value for m, displayed below.";
    /**
     * The instruction that prompts the user for the selection of <i>w</i>.
     */
    private static final String PROMPT_W = "Please enter a possible value for w and press \"Enter\".";
    /**
     * The description outlining the nature of the decomposition <i>w</i>.
     */
    private static final String DESCRIBE_DECOMPOSITION = "I have decomposed w into the following...";
    /**
     * The instruction that prompts the user for the selection of <i>i</i>.
     */
    private static final String PROMPT_I = "Please enter a possible value for i and press \"Enter\".";
    /**
