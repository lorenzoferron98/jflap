...
public class HumanRegPumpingLemmaInputPane extends HumanFirstPane {
     ...
     */
    private static final String YOU_WIN = "YOU WIN. Does this mean the language is regular?";
    /**
     * The instruction that prompts for the decomposition of <i>w</i>.
     */
    private static final String PROMPT_DECOMPOSITION = "Please select the decomposition of w into xyz using the sliders.";
