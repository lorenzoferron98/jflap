...
public class ConfigurationButton extends JToggleButton {
     ...
     *
     * @param config the configuration to set the configuration button for
     */
     ...
     *
     * @param config the configuration to set the configuration button for
     * @param state  the state to create the configuration button with, with states
     ...
     *
     * @param state the new state, for example, <CODE>NORMAL</CODE>
     */
     ...
     *
     * @param g the graphics object to paint this component to
     */
