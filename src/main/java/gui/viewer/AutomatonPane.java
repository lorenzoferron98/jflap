...
//		reformTransform(new Rectangle(getSize()));
     ...
     *
     * @param bounds the current bounds of the drawing area, which may be used if
...
//			}
     ...
     *
     * @param event the mouse event to transform
     */
     ...
     *
     * @param point the point, which will be modified
     */
