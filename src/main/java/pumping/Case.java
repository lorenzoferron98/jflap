 ...
 * for each class of {@link PumpingLemma}.
 *
 * @author Jinghui Lim
 */
public abstract class Case {
     ...
     * {@link Case}, this method should have access to <i>m</i>
     * of the {@link PumpingLemma} either as an internal
     ...
     */
    public int[] getInput() {
        return userInput == null ? getPreset() : userInput;
    }
