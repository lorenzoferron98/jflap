...
public class RegularExpression implements Serializable {
     ...
     *
     * @param ref the reference to a string to change the regular expression to
     */
     ...
     * @throws UnsupportedOperationException if the expression is not properly formed
     */
    ...
    protected void distributeChangeEvent(String old) {
        ...
        for (ExpressionChangeListener l : listeners) {
